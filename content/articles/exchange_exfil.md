...
I was eventually able to recover those messages from backups, which I realized
only after struggling with IMAP for a while.
...
Turns out those are fairly easy to convert[debian](footnote://) to
