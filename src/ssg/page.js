import { clone, CustomError, normalizeFilename } from "./util.js";
...
export class Page {
	...
	constructor(name, metadata, blocks, source, assets = null) {
		...
		for (let [field, convert] of Object.entries(this.constructor.fields)) {
			if (Object.hasOwn(this, field)) { // deno-fmt-ignore
			...
			if (value === INVALID) { // deno-fmt-ignore
				throw new CustomError("INVALID_CONTENT",
	...
	render(_context) { // deno-fmt-ignore -- TODO: memoize?
